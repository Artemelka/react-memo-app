...
export const HomePageButtons = memo(({
  decrement,
  increment,
  isDisableDecrement,
  idDisableIncrement,
  ...
  const handleIncrementClick = useCallback(() => increment(), [increment]);

  const handleDecrementClick = useCallback(() => decrement(), [decrement]);

  const handleStartAutoIncrement = useCallback(() => {
    setIsStart(true);
    increment();
  ...
  const handleStopAutoIncrement = useCallback(() => {
    setIsStart(false);
